(() => {
  ...
  const styles = `
    ...
    *{box-sizing:border-box}
    ...
    .gallery-nav::before{content:"";width:16px;height:20px;transform:translateX(2px);background:currentColor;-webkit-mask:center/contain no-repeat;mask:center/contain no-repeat}
