(() => {
  ...
  const styles = `
    ...
    *{box-sizing:border-box}
    ...
    .gallery-nav{position:fixed;z-index:2;top:50%;transform:translateY(-50%);width:56px;height:56px;border:0;border-radius:50%;background:rgba(0,0,0,.48);color:#fff;cursor:pointer;display:grid;place-items:center;padding:0;font-size:0;line-height:1}
    ...
    .gallery-nav:hover{background:rgba(0,0,0,.64)}
    ...
    @media(max-width:760px){
      ...
      .gallery-nav{width:48px;height:48px;background:rgba(0,0,0,.42)}.gallery-nav::before{width:12px;height:12px;border-width:2.25px}.previous{left:4px}.next{right:4px}.viewer-caption{padding:0 14px}.viewer-caption p{font-size:19px}.image-counter{font-size:9px}.close{right:10px;top:10px}
    }
